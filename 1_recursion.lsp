...
; 1. Подгрузите файл пори помощи (load "1_recursion.lsp").
; 2. Функция aShow демонстрирует решение задания 7.a, запустите в консоли (aShow).
; 3. Функция bShow демонстрирует решение задания 7.b, запустите в консоли (bShow).
